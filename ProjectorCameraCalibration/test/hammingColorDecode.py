...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_dir', '-in_dir', type=str, default='TestImages')
    parser.add_argument('--lit_thr', '-lit_thr', type=int, default=40)
    parser.add_argument('--output_dir', '-out_dir', type=str, default='testDecoded')
    parser.add_argument('--output_8bit_dir', '-out_8bit_dir', type=str, default='testDecoded8')
    parser.add_argument('--output_mask_dir', '-out_mask_dir', type=str, default='testMask')
    ...
    if not os.path.exists(input_dir):
        print
        '{} does not exist.'.format(input_dir)
        sys.exit()
