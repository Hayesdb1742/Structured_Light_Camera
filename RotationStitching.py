...
def stitch_rotating_object(directory, rotation_axis='y', degrees_per_capture=30):
    """
    ...
    for i in range(1, len(o3d_point_clouds)):
        ...
        angle = np.radians(i*degrees_per_capture) # Makes view 0 Primary Viewing angle
...
stitched_pc = stitch_rotating_object(directory, file_prefix, rotation_axis='z', degrees_per_capture=10)
